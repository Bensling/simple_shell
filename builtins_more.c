...
/**
 * my_builtin_exit - exit the program with a status
...
/**
 * my_builtin_cd - change the current directory
 * @data: struct for the program's data
 *
 * Return: zero if success, or other number if it's declared in the arguments
 */
...
/**
 * my_builtin_help - display help messages
 * @data: struct for the program's data
 *
 * Return: zero if success, or other number if it's declared in the arguments
 */
...
/**
 * my_builtin_alias - add, remove, or show aliases
 * @data: struct for the program's data
 *
 * Return: zero if success, or other number if it's declared in the arguments
 */
